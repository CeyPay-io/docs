...
- **Security Issues**: Email [security@ceypay.io](mailto:security@ceypay.io) directly
...
Join our community discussion group for real-time support and discussions:

- **Telegram Group**: [Join Discussion](https://t.me/+ZKEDnOf0z-NkNDll)
- **Best for**: Quick questions, community discussions, real-time support
- **Language**: English and Sinhala supported
