...
<Frame>![CeyPay WordPress Plugin](/images/assets/repo_cover.png)</Frame>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="wordpress"
    href="/integrations/wordpress/quickstart#installation"
  >
  ...
  <Card
    ...
    icon="webhook"
    href="/integrations/wordpress/webhooks"
  >
  ...
  <Card
    ...
    icon="shield-check"
    href="/integrations/wordpress/privacy"
  >
